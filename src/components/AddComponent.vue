            ...
            <div class="w-full p-4 max-w-md bg-white border border-primary rounded-lg shadow-xl sm:p-8">
                <div class="mx-auto bg-white">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-2">
                            <div
                                class="flex w-full border border-secondary items-center justify-between bg-neutral-100 p-3 rounded-md">
                                <div class="flex items-center gap-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5"
                                        stroke="currentColor" fill="none" class="stroke-primary w-6 h-6">
